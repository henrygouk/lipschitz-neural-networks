...
datapath=/research/repository/hgrg1/fashion-mnist
modelpath=/research/repository/hgrg1/lipschitz-neural-networks/fashion-mnist
logpath=logs/fashion-mnist
...
./mnist --datapath=$datapath --modelpath=$modelpath/l1-batchnorm.model --logpath=$logpath/l1-batchnorm.log --batchnorm --norm=1 --lambda=3
